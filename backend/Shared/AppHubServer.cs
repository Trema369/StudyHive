...
public interface IAppHubServer
{
    ...
    Task<Class> SetPinnedLinks(string classId, List<PinnedLink> links);
    ...
    Task<List<Class>> GetPublicClasses();
    Task<Class> PromoteToTeacher(string classId, string userId);
    Task<Class> SetClassVisibility(string classId, bool isPublic);
    Task<Class> SetClassAccentColor(string classId, string accentColor);
    Task<ClassThreadPost> CreateClassThreadPost(ClassThreadPost post);
    Task<List<ClassThreadPost>> GetClassThreadPosts(string classId);
    Task<ClassThread> CreateClassThread(ClassThread thread);
    Task<ClassThread> UpdateClassThread(ClassThread thread);
    Task<List<ClassThread>> GetClassThreads(string classId);
    Task<ClassThreadComment> CreateClassThreadComment(ClassThreadComment comment);
    Task<ClassThreadComment> UpdateClassThreadComment(ClassThreadComment comment);
    Task<List<ClassThreadComment>> GetClassThreadComments(string threadId);
    Task<Assignment> CreateAssignment(Assignment ass);
    Task<Assignment> UpdateAssignment(Assignment ass);
