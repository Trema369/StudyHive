...
public class EcocashClient
{
    ...
    public async Task<LookupTransactionResponse> LookupTransaction(string reference, string phone)
    {
        ...
        var body = new { sourceMobileNumber = phone, sourceReference = reference };
    ...
    public async Task<LookupTransactionResponse> PollTransaction(
        InitPaymentResponse response,
        PollStrategies strategy = PollStrategies.Interval,
    ...
    )
    {
        ...
        LookupTransactionResponse lookupResponse = await LookupTransaction(
        ...
        switch (strategy)
        {
            case PollStrategies.Interval:
                ...
                {
                    lookupResponse = await LookupTransaction(
                        response.sourceReference,
                        response.phone
                    );
